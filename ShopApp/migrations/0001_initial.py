# Generated by Django 4.1.2 on 2023-03-22 10:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotions', models.ManyToManyField(blank=True, to='ShopApp.promotion')),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orderitems', to='ShopApp.product')),
            ],
        ),
        migrations.AddField(
